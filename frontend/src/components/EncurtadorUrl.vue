<template>
  <div class="flex flex-col justify-center items-center min-h-screen">
    ...
    <div class="p-8 flex flex-col items-center">
      ...
      <div>
        <button @click="encurtar" type="button" class="bg-blue-500 text-white px-4 py-2 rounded hover:cursor-pointer hover:bg-blue-700">Encurtar</button>
      ...
      <div v-if="loading" class="mt-4 w-full border-2 border-white-300 p-3 rounded-lg">
